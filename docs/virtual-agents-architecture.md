...
- [API Endpoints](#api-endpoints)
  - [Backend Agent Builder Routes (`/backend/routes/virtual_assistants.py`)](#backend-virtual-assistant-routes-backendroutesvirtual_assistantspy)
...
This guide explains how virtual agents (AI assistants) work in the AI Agent Builder application, covering the complete data flow from creation to deletion, the integration between frontend and backend systems, and the relationship with LlamaStack for agent management.
...
### Backend Agent Builder Routes (`/backend/routes/virtual_assistants.py`)
