      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <ul className="flex space-x-6 text-sm font-medium text-gray-700">
            ...
            <li>
              <Link to="/virtual_assistants" className="hover:text-blue-600 transition">AaaSs</Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/virtual_assistant_chat" className="hover:text-blue-600 transition">AaaS Chat</Link>
            </li>
          </ul>
        </div>
      </div>
